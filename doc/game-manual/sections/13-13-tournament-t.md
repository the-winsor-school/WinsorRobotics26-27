...
Each *FIRST* Tech Challenge competition is played in a head-to-head tournament format. Each tournament consists of 3 types of MATCHES: Practice MATCHES (not played at all events), Qualification MATCHES, and Playoff MATCHES.
...
#### T201 — Replays are allowed, but rare. [Evergreen rule]

MATCH replays are only allowed in extreme circumstances due to an ARENA FAULT or for MATCHES which are stopped because FIELD STAFF anticipated FIELD damage or personal injury.
...
If, as determined by the Head REFEREE, an ARENA FAULT occurs that affects the outcome of the MATCH and any team on the affected ALLIANCE desires a replay, the MATCH will be replayed. In addition, *FIRST* Headquarters reserves the right to, with consultation of the Head REFEREE and FIELD STAFF, replay any MATCH in which an ARENA FAULT impacts the outcome of an event.
...
#### T202 — Replays will replicate the conditions of the original MATCH. [Evergreen rule]

All reasonable effort is made to create the same conditions when replaying a MATCH caused by an ARENA FAULT or FIELD damage. This includes:
...
Technical questions regarding FIELD or ROBOT operation are addressed by the FTA, and additional team members are invited to participate in these conversations if necessary. If a DRIVE TEAM needs clarification on a ruling or MATCH results, per T301, up to two STUDENTS should address the Head REFEREE after the MATCH results have been shown.
...
#### T301 — Head REFEREE interactions. [Evergreen rule]

A team may only address the Head REFEREE with a maximum of 2 people, 1 of which must be a STUDENT.

Violation: The Head REFEREE will not address additional, non-compliant team members or peripheral conversations.

Some events may restrict ARENA access to members of the DRIVE TEAM. Team members are permitted to swap buttons within their team as needed to access the Question Box.

As much as possible, the STUDENT should be an active participant in the conversation. Teams should not record interactions without consent (see E116).

#### T302 — MATCH questions must be timely. [Evergreen rule]

If a team would like to clarify or dispute the results of a MATCH using the process per T301 they must present their STUDENT representative in the question box in a timely manner as outlined below:
...
#### T303 — Keep questions factual and constructive. [Evergreen rule]

Teams coming to the Question Box should think through their requests in advance and are encouraged to have relevant references to rules or the [Q&A website](https://ftc-qa.firstinspires.org/qa) available to aid discussions.

There should be no negative implications for teams using the question box to advocate for themselves, but everyone should keep in mind it can be a high stress situation for team youth and for volunteers alike and it is important to remember [*FIRST* Core Values](https://www.firstinspires.org/about) during these discussions.\
At some events, MATCH results may be available on the [FTC-Events](https://ftc-events.firstinspires.org/) page.

## 13.4 General Tournament Rules

#### T401 — The Head REFEREE has ultimate and final authority regarding gameplay during the event. [Evergreen rule]

The Head REFEREE may receive input from additional sources, e.g., *FIRST* personnel, FTA, Event Director, Program Delivery Partner, and other event staff. The Head REFEREE rulings are final. No event staff, including the Head REFEREE, will review video, photos, artistic renderings, etc. of any MATCH, from any source, under any circumstances.
...
#### T403 — The Event Director has ultimate authority regarding all non-gameplay decisions during an event. [Evergreen rule]

The Competition Manual is intended to provide a set of rules for the competition including gameplay and judging but it is not an exhaustive compilation of guidelines for running a *FIRST* Tech Challenge event. Issues outside of specific gameplay rules which are under the authority of the Head REFEREE per T401 are at the discretion of the Event Director such as, but not limited to:
...
#### T404 — All competition FIELDS at an event must be consistent with each other. [Evergreen rule]

Events which have multiple competition FIELDS (as indicated by the MATCH schedule Figure 13-1) will be consistent with each other. Examples of set-up which must be considered includes, but is not limited to:
...
#### T405 — During optional FIELD measurement and calibration time(s) ROBOTS may not practice on the FIELD. [Evergreen rule]

During any period when the ARENA is open for measurement, ROBOTS may run OpModes but cannot move the ROBOT (e.g., CHASSIS) under its own power around the FIELD.
...
G. team members may manually move the ROBOT to multiple positions around the FIELD (e.g., without driving the ROBOT under its own power), and
...
K. team members may not practice (e.g., repetitive actions by a team member in the ALLIANCE AREA placing SCORING ELEMENTS).

#### T406 — No team timeouts, but MATCHES have breaks. [Evergreen rule]

Teams playing in back-to-back MATCHES will have a minimum break between their MATCHES as follows:
...
#### T407 — MATCHES are played in order. [Evergreen rule]
...
Practice MATCHES are played before Qualification MATCHES, at events that have them. The Practice MATCH schedule is available as soon as possible but no later than the start of Practice MATCHES. Schedules may also be available on the [FTC-Events](https://ftc-events.firstinspires.org/) site.
...
| **2nd** | Average ALLIANCE MATCH points, not including MINOR FOULS and MAJOR FOULS (Average MATCH points minus FOULS) |
| **3rd** | Average number of TIPS |
| **4th** | Average AUTO points |
| **5th** | Random sort by the *FIRST* event management software |

#### T601 — DISQUALIFICATION applies only to the DISQUALIFIED team in Qualifications. [Evergreen rule]

During Qualification MATCHES, a team DISQUALIFICATION has no effect on their ALLIANCE partner.
...
#### T701 — Send one or two STUDENT representatives. [Evergreen rule]

Each team must choose and send a minimum of one and a maximum of two STUDENT team representatives to the ARENA at the designated ALLIANCE selection time (typically just after the last scheduled Qualification MATCH) to represent their team.
...
#### T703 — There are no backup teams in Playoff MATCHES. [Evergreen rule]

An ALLIANCE may not request a backup team in a Playoff MATCH.
...
#### T704 — During Playoff MATCHES, teams may have more ARENA access. [Evergreen rule]
...
#### T705 — Multiple DISQUALIFICATION is handled specially. [Evergreen rule]

During Playoff MATCHES, 1 or more ALLIANCE DISQUALIFICATIONS are handled accordingly:
...
| **Total playoff eligible teams** | **Number of playoff ALLIANCES formed** |
|---|---|
| **4-10 Teams** | 2 |
| **11-20 Teams** | 4 |
| **21-40 Teams** | 6 |
...
[Figure: Diagram showing 2-ALLIANCE bracket.]
...
[Figure: Diagram showing 4-ALLIANCE bracket.]
...
[Figure: Diagram showing 6-ALLIANCE bracket.]
...
#### T801 — Divisions will use the same size playoff brackets. [Evergreen rule]

The number of playoff ALLIANCES will be determined based on the number of playoff eligible teams in the smaller division as shown in Table 13-2.

#### T802 — Dual Division awards are given at the event level. [Evergreen rule]

All awards are judged and awarded at the tournament level, not the division level.

#### T803 — Dual Division award counts are based on total teams. [Evergreen rule]

The number of awards distributed at a Dual Division event is determined using Table 6-1.
...
[Figure: Diagram showing 2-ALLIANCE Dual Division bracket.]
